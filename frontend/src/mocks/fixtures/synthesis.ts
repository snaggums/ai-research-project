...
export const sessionReportFixture: SessionReport = {
  ...
  items: [
    { id: "requirement-1", type: "requirement", title: "Keep order context visible", summary: "Display a compact order summary throughout checkout.", provenance: "AI Generated · 2 supporting excerpts", evidence: synthesisEvidenceFixtures.slice(0, 2) },
    { id: "decision-1", type: "decision", title: "Use a persistent progress indicator", summary: "Show the current checkout step and completed steps on mobile.", provenance: "AI Generated · 2 supporting excerpts", evidence: synthesisEvidenceFixtures.slice(1) },
    { id: "action-1", type: "action-item", title: "Prototype summary persistence", summary: "Test a compact sticky order summary in the next usability session.", provenance: "AI Generated · 1 supporting excerpt", evidence: synthesisEvidenceFixtures.slice(0, 1) },
    { id: "question-1", type: "open-question", title: "How much order detail is necessary?", summary: "Validate which cart details must remain visible without crowding the mobile viewport.", provenance: "AI Generated · 1 supporting excerpt", evidence: synthesisEvidenceFixtures.slice(0, 1) },
    { id: "insight-1", type: "key-insight", title: "Visibility supports trust", summary: "Participants interpreted missing order context as a risk that their selections had been lost.", provenance: "AI Generated · 3 supporting excerpts", evidence: synthesisEvidenceFixtures },
  ],
