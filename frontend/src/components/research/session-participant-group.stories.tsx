...
const meta = { title: "Research Objects/Session/Session Participant Group", component: SessionParticipantGroup, tags: ["autodocs"], decorators: [(Story) => <div className="mx-auto max-w-4xl p-6"><Story /></div>], args: { onAddParticipant: () => undefined, participants } } satisfies Meta<typeof SessionParticipantGroup>;
export default meta;
